...
public class CardboardReticlePointer : MonoBehaviour
{
    ...
    private Vector3 initialPlayerPos = new Vector3(0f, 1f, 0f);
    private Vector3 playerPos = new Vector3(0f, 1f, 3.6f);
    ...
    {
        Vector3 startPlayerPos, targetPlayerPos;

        if(isInitial) 
        {
            startPlayerPos = initialPlayerPos;
            targetPlayerPos = playerPos;
        }
        else 
        {
            startPlayerPos = playerPos;
            targetPlayerPos = initialPlayerPos;
        }
