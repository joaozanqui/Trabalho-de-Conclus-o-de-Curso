...
public class BocaController : MonoBehaviour
{
    ...
    public float midDistance = 0.4f;
    public float downDistance = 0.2f;

    public Quaternion upRot = Quaternion.Euler(-25f, 0f, 0f);
    public Quaternion downRot = Quaternion.Euler(30f, 0f, 0f);


    private Renderer _myRenderer;
    private Vector3 _startingPosition;
    private bool isClicked = false;
    private bool openTheMouth = false;
    ...
    public void getInitialPosition()
    {
        ...
        upPos = transform.right * upDistance;
    ...
    private IEnumerator openMouth(bool isMouthOpen)
    {   
    ...
    {
        openTheMouth = !openTheMouth;
        if(!isClicked) {
            StartCoroutine(openMouth(openTheMouth));
        }
